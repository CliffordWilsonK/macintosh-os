...
export default function Spotify() {
  return (
    <div className="grid gap-2">
      <div className="bg-[#186b45] p-4 relative flex items-center gap-3">
        ...
        <div className="flex flex-col gap-2 relative z-10">
          <span className={clsx(righteous.className, "text-3xl text-white")}>
            Techcosmocrat
          </span>
          <Link
            target="_blank"
            rel="noopener noreferrer"
            href="https://open.spotify.com/user/31soad2aalktnkfkkxq6zana733m?si=f372bf7d984e45f5"
          ...
          {topArtists.map((artist) => (
            ...
            >
              <div className="relative group">
                ...
                />
                <div className="absolute bottom-0 right-0 group-hover:opacity-100 transition-all duration-300 group-hover:-translate-y-2 opacity-0 w-12 h-12 z-10 rounded-full bg-green-500 grid place-items-center group-active:scale-95 group-active:rotate-12 group-active:-translate-y-1">
      ...
      <p className="text-center opacity-75 text-sm">
        Music is the Gateway to the Soul, Guard it Well.
      </p>
    </div>
  );
}
