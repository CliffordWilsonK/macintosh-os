        ...
        <div className="p-2">
            <div className="flex items-center gap-2">
                ...
                <div className="grid gap-1">
                    <h3 className={clsx(righteous.className, "text-2xl font-medium")}>CliffordWilsonK</h3>
                    <p className="text-sm opacity-80">
                        A passionate developer crafting innovative web experiences with modern technologies. Exploring the intersection of design and functionality.
                    </p>
                </div>

            </div>
            <div className="flex items-center gap-1 my-5">
                <Link title="Drop me a message anonymously" href="https://secret-room-orpin.vercel.app/" target="_blank" rel="noopener noreferrer" className="bg-background flex items-center gap-1 justify-center flex-2 shadow-[0px_5px_25px_rgba(0,0,0,0.05)] px-5 py-3 text-sm rounded-full w-fit cursor-pointer hover:border-foreground/20 border border-foreground/5 active:scale-95 transition-all duration-300 active:opacity-75">
                    <AnnoyedIcon size={20} />
                    Anonymous Feedback
                </Link>
                ...
                <Link href="https://github.com/CliffordWilsonK/macintosh-os" target="_blank" rel="noopener noreferrer" title="Star this repo" className="bg-background shadow-[0px_5px_25px_rgba(0,0,0,0.05)] flex items-center justify-center px-5 py-3 text-sm rounded-full w-fit cursor-pointer hover:border-foreground/20 border border-foreground/5 active:scale-95 transition-all duration-300 active:opacity-75">
                    <Github size={20} />
