...
export default function Finder() {
  ...
  const mailConstant = icons.find(
    (icon) => icon.tooltip.toLocaleLowerCase() === "mail"
  )!;
    ...
    <div className="p-2">
      <div className="flex items-center gap-2">
        ...
        <div className="grid gap-1">
          <h3 className={clsx(righteous.className, "text-2xl font-medium")}>
            Clifford Wilson
          </h3>
          <p className="text-sm opacity-80">
            Developer of Cool Websites, The Problem Solver, Web3 Enthusiast, and
            Passionate Coder &mdash; rebuilding the world, one line of code at a
            time.
          </p>
        </div>
      </div>
      <div className="flex items-center gap-1 my-5">
        <Link
          ...
          href="https://gdpd.xyz/techcosmocrat "
          target="_blank"
        ...
        <Link
          href="https://github.com/CliffordWilsonK/macintosh-os"
          target="_blank"
          rel="noopener noreferrer"
