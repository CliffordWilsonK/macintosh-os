    ...
    return (
        <div className="p-2 grid grid-cols-[repeat(auto-fill,minmax(100px,1fr))] gap-3">
            {trash.map((item) => (
                ...
                >
                    <div className="p-1 rounded-lg group-focus:bg-foreground/5 group-hover:bg-foreground/2 w-[100px] border border-transparent group-focus:border-blue-600/50 transition-all duration-300">
                        <Image
                            src={item.icon}
                            alt={item.name}
                            width={250}
