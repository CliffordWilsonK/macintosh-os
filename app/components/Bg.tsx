  ...
  return (
    <div className="fixed inset-0">
      <Image
        ...
        draggable={false}
        priority
        className={clsx(theme === "dark" && "brightness-75 -contrast-50")}
      />
      <div className="absolute h-full w-full grid place-items-center">
        <div className="text-center">
          ...
          >
            <span>&quot;</span>A passionate developer crafting digital
...
function CharacterSpan({ character, delay }: CharacterSpanProps) {
  ...
  return (
    <span
      className={clsx("relative cursor-pointer transition-all duration-300")}
