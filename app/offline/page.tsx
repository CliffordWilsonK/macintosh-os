  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-900 dark:to-gray-800 flex items-center justify-center p-4">
      ...
      >
        ...
        >
          The Macintosh OS PWA couldn't load properly. This might be due to a
          network issue or the app being offline.
        </motion.p>
        ...
        >
          <p className="text-sm text-yellow-800 dark:text-yellow-200">
            <strong>Tip:</strong> Check your internet connection or try
            refreshing the page. Some features may still work offline.
          </p>
        </motion.div>
